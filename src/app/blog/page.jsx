    ...
    <div className="min-h-screen bg-[#010409] text-white">
      ...
      <main className="mx-auto max-w-5xl space-y-8 px-4 py-14 sm:px-6 lg:px-8">
        <div className="space-y-4">
          <p className="text-sm uppercase tracking-[0.4em] text-rose-300">Blog</p>
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Latest articles and ideas.</h1>
        </div>
        <div className="grid gap-4">
          {posts.map((post) => (
            <article key={post.title} className="rounded-3xl border border-white/10 bg-slate-900/80 p-8">
